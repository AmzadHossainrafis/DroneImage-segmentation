...
class Unet(nn.Module):
    ...
    def __init__(self,n_class=22, in_channels=3, filters=[64, 128, 256, 512, 1024]):
        ...
        self.trans1 = nn.ConvTranspose2d(filters[4], filters[3], kernel_size=2, stride=2) 
        ...
        self.trans2 = nn.ConvTranspose2d(filters[3], filters[2], kernel_size=2, stride=2)
        ...
        self.trans3 = nn.ConvTranspose2d(filters[2], filters[1], kernel_size=2, stride=2)
        ...
        self.trans4 = nn.ConvTranspose2d(filters[1], filters[0], kernel_size=2, stride=2)
